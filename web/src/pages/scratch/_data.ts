...
export const TOYS: Toy[] = [
  ...
  { name: 'Vernier Go Direct Turbidity', short: 'Turbidity', sci: 'phys', kind: 'bench',
    note: 'How cloudy is cloudy', status: 'boxed', shots: 0 },
  ...
  { name: 'Vernier Go Direct Polarimeter', short: 'Polarimeter', sci: 'chem', kind: 'bench',
    note: 'Which way the sugar turns light', status: 'boxed', shots: 0 },
  ...
  { name: 'GELATO Electrophoresis and Visualization System', short: 'Electrophoresis', sci: 'bio', kind: 'bench',
    note: 'Sort by size, look with blue light', status: 'working', img: CENT('photos/samples/samples12.jpeg'), shots: 5 },
  ...
  { name: 'Vernier Go Direct O2 + CO2 Gas Sensor Bundle', short: 'Respiration', sci: 'bio', kind: 'bench',
    note: 'What went in vs. what came out', status: 'boxed', shots: 0 },
...
export const STREAM: Shot[] = [
  ...
  { src: CENT('photos/samples/samples9.jpeg'), cap: 'Rack of everything', toy: 'Electrophoresis', sci: 'bio', date: 'Apr 11' },
  { src: CENT('photos/samples/samples7.jpeg'), cap: 'Blue caps this time', toy: 'PCR', sci: 'bio', date: 'Apr 11' },
  { src: CENT('photos/setup/setup3.jpeg'), cap: 'Weighing it out', toy: 'Temperature', sci: 'bio', date: 'Apr 11' },
  { src: MELT('photos/setup/setup3.jpeg'), cap: 'Watching the capillary go clear', toy: 'Temperature', sci: 'chem', date: 'Apr 5' },
  { src: MELT('photos/setup/setup6.jpeg'), cap: 'The stage, mid-transition', toy: 'Temperature', sci: 'chem', date: 'Apr 5' },
